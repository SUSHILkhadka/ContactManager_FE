      ...
      <BrowserRouter>
        ...
        <Routes>
          <Route path="/" element={<BasicLayout />}>
            ...
            <Route path="/contact" element={<AdminRoute loggedIn={authInfo.login} />}>
            ...
            <Route path="/logout" element={<AdminRoute loggedIn={authInfo.login} />}>
              <Route index element={<LogoutPage />} />
            </Route>
            <Route path="/edit" element={<AdminRoute loggedIn={authInfo.login} />}>
